...
# cambios = [
#     CambioEstado(estados[3], hace_3_dias, hace_2_dias, "Usuario A", motivos[:1]),
#     CambioEstado(estados[4], hace_2_dias, hace_1_dia, "Usuario B", []),
#     CambioEstado(estados[4], hace_1_dia, "", "Usuario C", []),
#     CambioEstado(estados[3], hace_3_dias, hace_2_dias, "Técnico 1", motivos[:2]),
#     CambioEstado(estados[4], hace_2_dias, hace_1_dia, "Técnico 2", []),
#     CambioEstado(estados[3], hace_1_dia, "", "Técnico 3", motivos[:4]),  
# ]
